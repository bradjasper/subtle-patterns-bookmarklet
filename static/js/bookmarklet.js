  ...
  */
  ...
  SubtlePatternsBookmarklet = (function() {
    ...
    SubtlePatternsBookmarklet.prototype.create = function() {
      ...
      */
      this.el = $(subtlepatterns_bookmarklet_overlay).addClass(this.klass);
      this.el.hide().appendTo(this.parent);
      this.show();
      return $(subtlepatterns_bookmarklet_body_html).appendTo("body");
    };
    ...
    SubtlePatternsBookmarklet.prototype.toggle_keyboard_shortcuts_dialog = function() {
      return $("#subtlepatterns_bookmarklet_keyboard_shortcuts").fadeToggle();
    };

    SubtlePatternsBookmarklet.prototype.show_keyboard_shortcuts_dialog = function() {
      return $("#subtlepatterns_bookmarklet_keyboard_shortcuts").fadeIn();
    };

    SubtlePatternsBookmarklet.prototype.hide_keyboard_shortcuts_dialog = function() {
      return $("#subtlepatterns_bookmarklet_keyboard_shortcuts").fadeOut();
    };
    ...
    SubtlePatternsBookmarklet.prototype.setup_events = function() {
      ...
      */
      ...
      $("html").click(function(e) {
        _this.el.find(".menu .submenu").fadeOut();
        return _this.hide_keyboard_shortcuts_dialog();
      });
