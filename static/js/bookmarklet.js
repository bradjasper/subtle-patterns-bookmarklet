  ...
  */
  ...
  SubtlePatternsBookmarklet = (function() {
    ...
    function SubtlePatternsBookmarklet() {
      ...
      this.close_settings_menu = __bind(this.close_settings_menu, this);

      this.hide_keyboard_shortcuts_dialog = __bind(this.hide_keyboard_shortcuts_dialog, this);

      this.show_keyboard_shortcuts_dialog = __bind(this.show_keyboard_shortcuts_dialog, this);

      this.toggle_keyboard_shortcuts_dialog = __bind(this.toggle_keyboard_shortcuts_dialog, this);
    ...
    SubtlePatternsBookmarklet.prototype.create = function() {
      ...
      */
      this.el = $(template_bookmarklet).addClass(this.klass);
      this.el.hide().appendTo(this.parent);
      this.show();
      return $(template_body).appendTo("body");
    };
    ...
    SubtlePatternsBookmarklet.prototype.update = function() {
      ...
      */
      ...
      var categories, description, pattern, pattern_link;
    ...
    SubtlePatternsBookmarklet.prototype.toggle_keyboard_shortcuts_dialog = function() {
      return $("#spb_keyboard_shortcuts").fadeToggle();
    };

    SubtlePatternsBookmarklet.prototype.show_keyboard_shortcuts_dialog = function() {
      return $("#spb_keyboard_shortcuts").fadeIn();
    };

    SubtlePatternsBookmarklet.prototype.hide_keyboard_shortcuts_dialog = function() {
      return $("#spb_keyboard_shortcuts").fadeOut();
    };

    SubtlePatternsBookmarklet.prototype.close_settings_menu = function() {
      return this.el.find(".menu .submenu").fadeOut();
    };
      ...
      */
      ...
      $(document).keydown(function(e) {
        if (e.keyCode === 191 && e.shiftKey) {
          _this.toggle_keyboard_shortcuts_dialog();
          return;
        }
        ...
        switch (e.keyCode) {
          case 27:
            return _this.hide_keyboard_shortcuts_dialog();
          case 37:
          ...
          case 82:
            return _this.random();
          case 83:
            return _this.start_element_selector();
          case 84:
            return _this.toggle();
        }
      });
      ...
      $("html").click(function(e) {
        _this.close_settings_menu();
        return _this.hide_keyboard_shortcuts_dialog();
      });
      this.el.find(".show_keyboard_shortcuts").click(function(e) {
        _this.show_keyboard_shortcuts_dialog();
        _this.close_settings_menu();
      ...
      this.el.find(".close_bookmarklet").click(function(e) {
        _this.revert_background();
        _this.hide();
        return delay(500, _this.el.remove(), $(document).unbind("keydown"));
      });
    ...
    SubtlePatternsBookmarklet.prototype.start_element_selector = function() {
      var _this = this;
      ...
      this.element_selector = new ElementSelector({
        ...
        stop: function() {
          ...
          _this.el.find(".cancel_change_selector").fadeOut(function() {
            return _this.el.find(".menu").fadeIn();
          });
          return _this.element_selector = null;
        }
      });
      return this.element_selector.start();
    };
    ...
    SubtlePatternsBookmarklet.prototype.revert_background = function() {
      ...
      if (this.events.revert_background) {
        return this.events.revert_background();
      }
    };
    ...
    SubtlePatternsBookmarklet.prototype.update_selector = function(selector) {
      ...
      this.original_background = this.selector.css("background-image");
      if (this.events.update_selector) {
        this.events.update_selector();
      }
      return this.update();
    };
